                    ...
                    <table class="table table-striped w-100" id="table_id">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" class="id_empresa">Empresa</th>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="id_empresa"><?= $value->id_empresa; ?></td>
                                    <td class="acoes"><a href="./API/views/funcionarios.php?id_funcionario=<?= $value->id_funcionario; ?>&acao=buscar"><button type="button" class="apagarTexto btn btn-warning btn-sm acoes"><span class="bi bi-eye-fill"></span> Visualizar/Editar</button></a>
                                        <button type="button" class="apagarTexto btn btn-danger btn-sm acoes" data-toggle="modal" data-target="#excluir<?= $value->id_funcionario; ?>"><span class="bi bi-trash-fill"></span> Excluir</button>
                                    </td>
                                </tr>
                                <!-- Modal -->
                                <div class="modal fade" id="excluir<?= $value->id_funcionario; ?>" tabindex="-1" role="dialog" aria-labelledby="TituloModalCentralizado" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <a href="./API/controller/funcionarios.php?id_funcionario=<?= $value->id_funcionario; ?>&acao=excluir"><button type="button" class="btn btn-danger btn-sm">Sim</button></a>
